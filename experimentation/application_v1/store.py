...
assets_folder = os.path.join(script_dir, "..", "assets_1")  # Store all output files in 'assets' folder
weights_path = os.path.join(assets_folder, "..", "assets", "20180402-114759-vggface2.pt")  # Path for model weights
